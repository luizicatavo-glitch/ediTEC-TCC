...
<body>
  ...
  <main>
    <div class="container">
      <div class="form-card">
        <h1>Entrar</h1>
        <form action="../site/backend/login.php" method="POST">
          <label for="email">E-mail</label>
          <input id="email" name="email" type="email">

          <label for="password">Senha</label>
          <div class="input-wrap">
            <input id="password" name="senha" type="password" minlength="6" required>
          ...
          <p class="muted">Ainda não possui conta? <a href="cadastro.php">Cadastre-se</a></p>
        </form>
      </div>
    </div>
  </main>
